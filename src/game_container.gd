...
@onready var instructions_scene : PackedScene = preload("res://src/ui/instructions_scene.tscn")
...
func spawn_instructions():
	var instructions_scene_inst = instructions_scene.instantiate()
	instructions_scene_inst.global_position = Vector2(0,0)
	add_child(instructions_scene_inst)
